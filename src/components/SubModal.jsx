...
const SubModal = ({ isOpen, onClose,id,carps,proteins,meals,expdate }) => {
    ...
    const addSub=(e)=>{
        e.preventDefault();
        axios.post(`/api/subscription/reactive/${id}`,{},{
            headers:{
                ...
                <div className="text-center">
                    {isSubmitted ? (
                        ...
                        <>
                            ...
                            <h2 className="p-10 text-center text-xl font-semibold">هل تريد إعادة الاشتراك ؟</h2>
